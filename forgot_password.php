                    ...
                    <div class="card-body">
                        <form class="form-floating" action="password_resetCode.php" method="POST">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                <button class="btn btn-warning me-md-2" type="submit" name="password_resetBtn"><span class="glyphicon glyphicon-name"></span><i class="fa fa-send"></i> Request Password Reset Link</button>
                            </div>
                        </form>
